...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """ Even if both & future question exists, only past questions are displayed """
    ...
    def test_two_past_question(self):
        ...
        question2 = create_question(question_text='Past question 2.', days=-60)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'],
                                 [question1, question2])
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """ The detail view of a question with publish date in the future returns a 404 """
    ...
    def test_past_question(self):
        """ The detail view of a question with publish date in the past returns a question """
